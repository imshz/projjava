...
public interface IMathTransform {
     ...
     * @return
     */
    ArrayList<Double> getCodomainConvexHull(ArrayList<Double> points);
     ...
     * @return
     */
    DomainFlags getDomainFlags(ArrayList<Double> points);
     ...
     * @return
     */
    ArrayList<double[]> transformList(ArrayList<double[]> points);
